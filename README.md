...
This extension's source code and its icon (`icons/`, generated by
[`scripts/generate_icons.py`](scripts/generate_icons.py)) were built with
the assistance of an AI coding agent (Claude Code, Anthropic). All
generated code, design decisions, and commits were reviewed by a human
before being merged.
